            ...
            @foreach ($environmentAccesses as $environmentAccess)
              <tr>
                ...
                <td class="text-center">
                    <a class="btn btn-outline-info btn-fw btn-rounded btn-sm"  href="#" onclick="window.open('{{route('EnvironmentAccesses.show',$environmentAccess->id)}}','Join Environment','width=1024,height=720')"><i class="mdi mdi-information-outline"></i></a>
                </td>
              </tr>
            @endforeach
          </tbody>
